...
import dev.stephenpearson.model.PlayerBankMessage;
import dev.stephenpearson.model.PlayerBankMessageObserver;
...
public class GUI implements MenuMessageObserver, BetPotMessageObserver, PlayerBankMessageObserver, HandValueMessageObserver{
	...
	public void paintMenus(Graphics g) {
		System.out.println("painting menus");
	...
	public void paintMenuElements(Graphics g) {
		System.out.println("painting menu elements");
		Graphics2D g2d = (Graphics2D) g;
	...
	public void update(PlayerBankMessage playerBankMessage) {
		...
		System.out.println("updating playerbank message. Message is: "+playerBankMessageString);
		notifyGuiObservers();
